...
export const heritageData = [
...

  {
    ...
    description:
      "Varanasi is a historic cultural centre known for its ghats, temples, spiritual traditions, music, silk and distinctive food culture.",

    history:
      "Varanasi has been an important centre of religious, cultural and intellectual life for centuries.",

    architecture:
      "The city is characterised by its riverside ghats, ancient temples, narrow lanes, historic neighbourhoods and traditional architecture.",

    details: [
      { title: "Region", value: "Northern India" },
      { title: "State", value: "Uttar Pradesh" },
      { title: "Known For", value: "Ghats & Spirituality" },
      { title: "Culture", value: "Banarasi Traditions" },
    ],
...

  {
    ...
    eyebrow: "JAIPUR, RAJASTHAN",
    tagline: "The Pink City of royal architecture and vibrant traditions.",

    description:
      "Jaipur is renowned for its forts, palaces, colourful markets, traditional crafts, festivals and Rajasthani cuisine.",

    history:
      "Founded in the 18th century, Jaipur became an important centre of Rajput power, architecture and commerce.",

    architecture:
      "The city's planned streets, pink facades, forts, palaces and historic markets reflect its royal architectural heritage.",

    details: [
      { title: "Founded", value: "18th Century" },
      { title: "State", value: "Rajasthan" },
      { title: "Known For", value: "Pink City" },
      { title: "Heritage", value: "Rajput Royal Culture" },
    ],
...

  {
    ...
    eyebrow: "AGRA, UTTAR PRADESH",
    tagline: "A city shaped by Mughal architecture and craftsmanship.",

    description:
      "Agra is a historic Mughal city famous for the Taj Mahal, Agra Fort, traditional crafts and rich Mughlai cuisine.",

    history:
      "Agra became one of the major centres of the Mughal Empire and developed into an important centre of architecture and craftsmanship.",

    architecture:
      "The city contains magnificent Mughal monuments built from red sandstone and white marble.",

    details: [
      { title: "Region", value: "Northern India" },
      { title: "State", value: "Uttar Pradesh" },
      { title: "Known For", value: "Taj Mahal" },
      { title: "Heritage", value: "Mughal" },
    ],
...

  {
    ...
    eyebrow: "KOLKATA, WEST BENGAL",
    tagline: "A city where history meets Bengali culture.",

    description:
      "Kolkata is known for colonial architecture, Bengali literature, Durga Puja, art, music, theatre and distinctive food traditions.",

    history:
      "The city developed as an important colonial centre and later became one of India's major cultural and intellectual hubs.",

    architecture:
      "Historic Kolkata combines colonial buildings, traditional Bengali homes, public institutions and religious landmarks.",
...

  {
    ...
    eyebrow: "MYSORE, KARNATAKA",
    tagline: "A royal city of palaces, festivals and South Indian culture.",

    description:
      "Mysore is known for its royal palace, Dasara celebrations, traditional crafts, silk and distinctive South Indian cuisine.",

    history:
      "Mysore developed as an important royal centre under the Wadiyar dynasty.",

    architecture:
      "The city features grand palaces, heritage buildings, temples and traditional markets reflecting its royal history.",

    details: [
      { title: "Region", value: "Southern India" },
      { title: "State", value: "Karnataka" },
      { title: "Known For", value: "Mysore Palace" },
      { title: "Culture", value: "Wadiyar Heritage" },
    ],
...

  {
    ...
    architecture:
      "The complex contains Buddhist monasteries, Hindu temples and Jain monuments carved directly into volcanic rock.",
